...
public class Container {
    ...
    public static final String DEFAULT_DRIVES = "D:" + Environment.getExternalStorageDirectory();
    ...
    private boolean showGPUName = true;
    private boolean showRAMUsage = true; 
    private boolean showRendererName = true;
    private boolean showCPUUsage = true;
    private boolean showPowerStatus = true;
    ...
    public boolean isShowGPUName() {
        return showGPUName;
    }

    public void setShowGPUName(boolean showGPUName) {
        this.showGPUName = showGPUName;
    }

    public boolean isShowRAMUsage() {
        return showRAMUsage;
    }

    public void setShowRAMUsage(boolean showRAMUsage) {
        this.showRAMUsage = showRAMUsage;
    }

    public boolean isShowRendererName() {
        return showRendererName;
    }

    public void setShowRendererName(boolean showRendererName) {
        this.showRendererName = showRendererName;
    }
    ...
    public boolean isShowPowerStatus() {
        return showPowerStatus;
    }

    public void setShowPowerStatus(boolean showPowerStatus) {
        this.showPowerStatus = showPowerStatus;
    }
    ...
    public void saveData() {
        try {
            ...
            data.put("showGPUName", showGPUName);
            data.put("showRAMUsage", showRAMUsage);
            data.put("showRendererName", showRendererName);
            data.put("showCPUUsage", showCPUUsage);
            data.put("showPowerStatus", showPowerStatus);
        ...
        for (Iterator<String> it = data.keys(); it.hasNext(); ) {
            ...
            switch (key) {
                ...
                case "showFPS" :
                    ...
                    break;
                case "showGPUName" :
                    setShowGPUName(data.getBoolean(key));
                    break;
                case "showRAMUsage" :
                    setShowRAMUsage(data.getBoolean(key));
                    break;
                case "showRendererName" :
                    setShowRendererName(data.getBoolean(key));
                    break;
                case "showCPUUsage" :
                    setShowCPUUsage(data.getBoolean(key));
                    break;
                case "showPowerStatus" :
                    setShowPowerStatus(data.getBoolean(key));
                    break;
